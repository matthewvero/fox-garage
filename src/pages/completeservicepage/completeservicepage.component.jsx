...
const CompleteServicePage = ({isMobile, history}) => {
      ...
      <HoveringBookNowButton/>
            <InfoPageHeader>
                  ...
                  <InfoPageImageContainer>
                        <Image
                              $image="https://printrat.sirv.com/fox/foximages/photo-1530046339160-ce3e530c7d2f.jpeg"
...
// <div style={{display: 'flex', flexDirection: 'column', width: '50%', marginTop: '30px'}}>
//<CustomButton $fontsize='2vw'>Book Now</CustomButton>
//</div>
...
export default connect(mapState)(CompleteServicePage) ;
